...
namespace DesktopClient.Framework.FontAwesome.svgnet.AttachedProperties
{
...
#else
                            target.Child = icon.CreateCanvas(primaryColor);
#endif
                        }
                    }
                    break;
...
#else
                            viewBox.Child = icon.CreateCanvas(primaryColor);
#endif
