...
namespace DesktopClient.Framework.FontAwesome.svgnet
{
    ...
    public partial class ImageAwesome
    {
        ...
        public static readonly DependencyProperty SecondaryColorProperty =
            DependencyProperty.Register("SecondaryColor", typeof(Brush), typeof(ImageAwesome), new PropertyMetadata(FontAwesomeDefaults
              .SecondaryColor, OnIconPropertyChanged));
